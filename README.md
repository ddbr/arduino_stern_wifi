...
## Features
- **WiFi**: verbindet sich automatisch mit den eingestellten Zugangsdaten.
...
3. Mit PlatformIO bauen/flashen:
   ...
   pio run -t upload
   ```
4. Gerät verbindet sich mit WLAN; die zugewiesene IP-Adresse wird im Serial Monitor ausgegeben. mDNS folgt, sobald die Basis stabil läuft.
