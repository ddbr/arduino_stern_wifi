...
## Features
- **WiFi + mDNS**: verbindet sich automatisch und bietet den Namen `Stern.local` im Netz.
...
- `POST /api/state`: JSON Payload mit `isOn`, `brightness`, `speed`, `effect`, `color.{r,g,b,w}`.
